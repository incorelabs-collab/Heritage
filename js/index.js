var app = {
    ...
    getAppDb: function() {
        ...
        return openDatabase('dbHeritage', localStorage.getItem('dbLocalVersion'), 'dbHeritage', (5 * 1022 * 1022));
    },
    getImgDb: function() {
        if(localStorage.getItem('imgDbLocalVersion') == null) {
            localStorage.setItem('imgDbLocalVersion','-1');
        }
        return openDatabase('imgDbHeritage', localStorage.getItem('imgDbLocalVersion'), 'imgDbHeritage', (5 * 1022 * 1022));
    },
    initialize: function() {
    ...
    doOnlineTasks: function() {
        var urlData = 'http://heritage.incorelabs.com/db_version.php';
    ...
    checkWithLocalDB: function(json) {
        if (localStorage.getItem("dbLocalVersion") != json[0][0]) {
            ...
            $.getJSON('http://heritage.incorelabs.com/male.php', function(maleData) {
                app.createTable(maleData,"male",1);
            });
            $.getJSON('http://heritage.incorelabs.com/female.php', function(femaleData) {
                app.createTable(femaleData,"female",2);
            });
            $.getJSON('http://heritage.incorelabs.com/common.php', function(commonData) {
                app.createTable(commonData,"common",3);
            });
            $.getJSON('http://heritage.incorelabs.com/kids.php', function(kidsData) {
                app.createTable(kidsData,"kids",4);
            });
            $.getJSON('http://heritage.incorelabs.com/directors.php', function(directorsData) {
    ...
    getImageAssets: function () {
        var urlImages = 'http://heritage.incorelabs.com/images/file-list.php?key=kamlesh';
